...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ContactList",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11ContactList11AppDelegate")
...
SWIFT_CLASS("_TtC11ContactList20ContactTableViewCell")
@interface ContactTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified contactIcon;
...
SWIFT_CLASS("_TtC11ContactList12PhoneContact")
...
SWIFT_CLASS("_TtC11ContactList13SceneDelegate")
...
SWIFT_CLASS("_TtC11ContactList14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(ContactList)) <UITableViewDataSource>
